...
export class DashboardService {
    ...
    async getDashboardStats(store: Store, query: DashboardQueryDto): Promise<DashboardStats> {
        ...
        const salesPercentageChange = this.calcPercentageChange(currentTotalSales, previousTotalSales);
        ...
        const profitPercentageChange = this.calcPercentageChange(currentNetProfit, previousNetProfit);
