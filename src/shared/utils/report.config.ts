...
export const REPORT_CONFIG: Record<ReportType, ReportConfig> = {
    [ReportType.Sale]: {
        ...
        filterOptions: { searchable: ['status'], sortable: ['createdAt', 'status'] },
        exportColumns: [
            { header: 'ID', key: 'id' },
    ...
    [ReportType.Purchase]: {
        ...
        filterOptions: { searchable: ['status'], sortable: ['createdAt', 'status', 'customDate'] },
        exportColumns: [
            { header: 'ID', key: 'id' },
            { header: 'Status', key: 'status' },
            { header: 'Customer', key: 'customer.name' },
    ...
    [ReportType.Inventory]: {
        ...
        fields: [
            ...
            'stockQuantities.id', 'stockQuantities.quantity',
            'stockQuantities.product.id', 'stockQuantities.product.name',
        ],
        filterOptions: { searchable: ['name', 'address'], sortable: ['createdAt', 'name'] },
        exportColumns: [
            { header: 'ID', key: 'id' },
    ...
    [ReportType.Payment]: {
        ...
        fields: [
            'id', 'amount', 'status', 'note', 'createdAt',
            'sale.id', 'purchase.id', 'storeSession.id',
        ],
        filterOptions: { searchable: ['status'], sortable: ['createdAt', 'status', 'amount'] },
        exportColumns: [
            { header: 'ID', key: 'id' },
    ...
    [ReportType.CashMovement]: {
        ...
        fields: [
            'id', 'type', 'amount', 'status', 'note', 'createdAt',
            'storeSession.id', 'createdBy.id', 'createdBy.name',
        ],
        filterOptions: { searchable: ['type', 'status', 'note'], sortable: ['createdAt', 'type', 'amount', 'status'] },
        exportColumns: [
            { header: 'ID', key: 'id' },
